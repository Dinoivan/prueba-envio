...
public class PesoLineaComercial extends BaseDomain implements Identifiable<Integer>, Serializable {
    ...
    // Raw attributes
    private Integer id;
    private BigDecimal porcentajePesoHomologacion;
    private BigDecimal porcentajePesoCondicionLic;
    private BigDecimal porcentajePesoMoneda;
    ...
    public BigDecimal getPorcentajePesoHomologacion() {
        return porcentajePesoHomologacion;
    }

    public void setPorcentajePesoHomologacion(BigDecimal porcentajePesoHomologacion) {
        this.porcentajePesoHomologacion = porcentajePesoHomologacion;
    }

    public PesoLineaComercial porcentajePesoHomologacion(BigDecimal porcentajePesoHomologacion) {
    ...
    public BigDecimal getPorcentajePesoCondicionLic() {
        return porcentajePesoCondicionLic;
    }

    public void setPorcentajePesoCondicionLic(BigDecimal porcentajePesoCondicionLic) {
        this.porcentajePesoCondicionLic = porcentajePesoCondicionLic;
    }

    public PesoLineaComercial porcentajePesoCondicionLic(BigDecimal porcentajePesoCondicionLic) {
    ...
    public BigDecimal getPorcentajePesoMoneda() {
        return porcentajePesoMoneda;
    }

    public void setPorcentajePesoMoneda(BigDecimal porcentajePesoMoneda) {
        this.porcentajePesoMoneda = porcentajePesoMoneda;
    }

    public PesoLineaComercial porcentajePesoMoneda(BigDecimal porcentajePesoMoneda) {
