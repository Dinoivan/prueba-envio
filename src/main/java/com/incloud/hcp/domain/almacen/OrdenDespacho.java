...
@Table(name="GA_ORDEN_DESPACHO")
public class OrdenDespacho extends BaseDomain implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(generator = "ORDEN_DESPACHO_ID_SEQ", strategy = GenerationType.SEQUENCE)
	@SequenceGenerator(name = "ORDEN_DESPACHO_ID_SEQ", sequenceName = "ORDEN_DESPACHO_ID_SEQ", allocationSize = 1)
	@Column(name="ID_ORDEN_DESPACHO", unique=true, nullable=false)
	private Integer id;
    ...
    @OneToMany(mappedBy = "ordenDespacho", targetEntity = OrdenDespachoTextoCabecera.class, fetch = FetchType.LAZY)
    private List<OrdenDespachoTextoCabecera> ordenDespachoTextoCabeceraList;
    ...
    public List<OrdenDespachoTextoCabecera> getOrdenDespachoTextoCabeceraList() {
        return ordenDespachoTextoCabeceraList;
    }

    public void setOrdenDespachoTextoCabeceraList(List<OrdenDespachoTextoCabecera> ordenDespachoTextoCabeceraList) {
        this.ordenDespachoTextoCabeceraList = ordenDespachoTextoCabeceraList;
    }
    ...
    public String toString() {
        return "OrdenDespacho{" +
                ...
                ", ordenDespachoTextoCabeceraList=" + ordenDespachoTextoCabeceraList +
                '}';
    }
}