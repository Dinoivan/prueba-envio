...
public class LicitacionProveedorPreguntaDeltaRest extends LicitacionProveedorPreguntaRest {
     ...
     */
    @Operation(summary = "Crea un registro de tipo LicitacionProveedorPregunta en base a una Lista")
    ...
    @Hidden
    @Operation(summary = "Genera Excel XLSX de registros de tipo LicitacionProveedorPregunta en base al ID de Licitacion")
