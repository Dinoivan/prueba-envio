...
public class LicitacionSubetapaDeltaRest extends LicitacionSubetapaRest {
    ...
    @Operation(summary = "Crea registro de tipo LicitacionSubetapa en base a Lista")
    ...
    public ResponseEntity<List<LicitacionSubetapa>> grabarLista(
        ...
        try {
            ...
            this.licitacionSubetapaDeltaService.
                    enviarCorreoActualizarEtapas(result,token);
    ...
    @Operation(summary = "Busca lista de tipo LicitacionSubetapa para la trazabilidad ")
    ...
    @Operation(summary = "Busca lista de tipo LicitacionProveedorRenegociacion para la trazabilidad (Renegociacion)")
