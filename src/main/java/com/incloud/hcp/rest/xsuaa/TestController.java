...
import com.incloud.hcp.config.security.DataService;
...
public class TestController {
    ...
    @PreAuthorize("hasAuthority('all-ipe')")
    ...
    public String requestUserToken(@AuthenticationPrincipal Token token) throws TokenFlowException {
        ...
        return "<p>The access-token (decoded):</p><p>" + userTokenResponse.getDecodedAccessToken().getPayload()
                ...
                + "</p><p>The access-token (encoded) can be found in the logs 'cf logs cfemployeebackend-xsuaa-usage --recent'</p>";
    }
