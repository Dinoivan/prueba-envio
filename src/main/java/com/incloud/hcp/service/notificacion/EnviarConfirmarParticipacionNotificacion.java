...
//    }
    ...
    public void enviar(MailSetting mailSetting, Licitacion licitacion, Proveedor proveedor) {
        ...
        String asunto = "CONFIRMAR PARTICIPACION LICITACION Nro. " + numeroLicitacion + " del PROVEEDOR: " + nombreProveedor + " (" + rucProveedor + ")";
        ...
        body = body + "<a href=\"" + urlPortal + "\">Click aquí para ver la Respuesta</a>";
        body = body + "</p>";
        body = body + "</td>";
        body = body + "</tr>";
        body = body + "</table>";
