...
//    }
    ...
    public void enviar(MailSetting mailSetting, Proveedor proveedor, Licitacion licitacion, String fechaCierre,
        ...
        String asunto = "Recordatorio " + descripcionSubEtapa + " - Licitación Nro. " + numeroLicitacion;
