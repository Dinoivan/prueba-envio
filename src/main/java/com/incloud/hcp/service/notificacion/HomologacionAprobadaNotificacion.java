...
//    }
    ...
    public void enviar(MailSetting mailSetting, Proveedor proveedor) {
        ...
        body = body + "Gracias por completar su información en el IProvider de Copeinca.<br/>";
        body = body + "Se confirma que a la fecha usted se encuentra Apto para participar en procesos de licitación en Copeinca.<br/>";
