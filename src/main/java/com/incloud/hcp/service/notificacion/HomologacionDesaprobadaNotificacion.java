...
public class HomologacionDesaprobadaNotificacion extends NotificarMail {
    ...
    private final String ASUNTO = "IProvider - Proveedor desaprobado";
...
//    }
    ...
    public void enviar(MailSetting mailSetting, Proveedor proveedor) {
        ...
        body = body + "Gracias por completar su información en el IProvider de Copeinca&#44; es necesario que corrija y/o<br/>";
