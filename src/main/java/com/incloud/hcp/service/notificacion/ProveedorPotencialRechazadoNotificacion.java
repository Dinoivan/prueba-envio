...
//    }
    ...
    public void enviar(MailSetting mailSetting, PreRegistroProveedor preRegistro){
        ...
        body = body + "Gracias por registrarse en el IProvider de Copeinca.<br/>";
        body = body + "En caso Copeinca requiera sus servicios&#44; el Comprador se pondrá en contacto con usted.";
        body = body + "</p>";
        body = body + "</td>";
        body = body + "</tr>";
        body = body + "</table>";
        ...
        try {
            this.enviarCorreoSap(preRegistro.getEmail(), ASUNTORECHAZO, body);
        } catch (Exception ex) {
