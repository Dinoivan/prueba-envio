 ...
 */
@Component
public class ReactivacionOrdenCompraNotificacion extends NotificarMail{
...
//    }
    ...
    public void enviar(OrdenCompra ordenCompra, EstadoOrdenCompra estadoOrdenCompra, Proveedor proveedor) {
        //String rucProveedor = proveedor.getRuc();
        String nombreProveedor = proveedor.getRazonSocial();
        String numeroOrdenCompra = ordenCompra.getNumeroOrdenCompra();
