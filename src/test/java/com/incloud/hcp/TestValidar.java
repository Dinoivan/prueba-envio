...
//            File sunatXml = FunctionsXML.convert(archivoSunat);
            ...
            if (isStandar) {//Como siempre estubo funcionando
                System.out.println("VerificarComprobanteRest 0 :: " + isStandar);
                ...
                System.out.println("VerificarComprobanteRest 1 :: " + isStandar);
                tipoComprobante = "01";
                ...
                for (int i = 0; i < generalNodeListTextSpan.getLength(); i++) {
                    ...
                    if (i == 0) { //Ruc Proveedor
                        ...
                        if (item.getTextContent() != null && item.getTextContent().equalsIgnoreCase("S/")) {
                            codigoMoneda = "PEN";
                            System.out.println("VerificarComprobanteRest 2 :: " + isStandar);
                        }
                    }
            ...
            if (refFacturaStrings.length > 1) {
                ...
                username.setObjectValue(rucCliente.concat("FESPINOZ"));
                usernameToken.addChild(username);
                password.setObjectValue("fESPINOZA1");
                ...
                if (isStandar) {//Como siempre estubo funcionando
                    System.out.println("VerificarComprobanteRest 3 :: " + isStandar);
                    ...
                    System.out.println("VerificarComprobanteRest 4 :: " + isStandar);
                    if (StringUtils.isNotBlank(fechaEmisionString)) {
                        System.out.println("VerificarComprobanteRest 5 :: " + isStandar);
                ...
                System.out.println("VerificarComprobanteRest  sociedad  :: " + sociedad.getCodigoSociedad() );
                System.out.println("VerificarComprobanteRest  rucProveedor  :: " + rucProveedor );
                System.out.println("VerificarComprobanteRest  fechaEmision  :: " + fechaEmision );
                System.out.println("VerificarComprobanteRest   referenciaFactura :: " +  referenciaFactura);
                System.out.println("LeerComprobante  Tipo Comprobante  :: " +  tipoComprobante);
                System.out.println("VerificarComprobanteRest  codigoMoneda  :: " +  codigoMoneda);
                System.out.println("VerificarComprobanteRest  igv  :: " +  igv);
                System.out.println("VerificarComprobanteRest  subTotal  :: " +  subTotal);
                System.out.println("VerificarComprobanteRest  montoTotal  :: " +  montoTotal);
